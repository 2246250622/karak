    ...
    [774], {
        7171: (e, t, s) => {
                    ...
                    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Object.is,
                        ...
                        g = arguments.length > 8 && void 0 !== arguments[8] ? arguments[8] : n => {
                            ...
                            const W = [I, function() {
                                ...
                                return v === e || f.size || (v = e, y.forEach((t => {
                                    let [s] = t;
                                    const o = s[1](e);
                                    o > i && (i = o)
                                }))), i
            ...
            const f = h({
                ...
                y = {
                    state: b,
                    subscribe: e => g(b.events, (() => e(function(e, t) {
                        const s = c.get(e);
                ...
                O = {
                    ...
                    setConfig(e) {
                        var t, s;
                        y.initialize(), I.setChains(e.chains), I.setIsAuth(Boolean(e.enableAuthMode)), I.setIsCustomMobile(Boolean(null == (t = e.mobileWallets) ? void 0 : t.length)), I.setIsCustomDesktop(Boolean(null == (s = e.desktopWallets) ? void 0 : s.length)), v.setModalVersionInStorage(), Object.assign(C, e)
                    }
                };
            ...
            const P = {
                ...
                getWalletImageUrl: e => `${k}/w3m/v1/getWalletImage/${e}?projectId=${O.state.projectId}&sdkType=${M}&sdkVersion=${U}`,
                getAssetImageUrl: e => `${k}/w3m/v1/getAssetImage/${e}?projectId=${O.state.projectId}&sdkType=${M}&sdkVersion=${U}`
            };
            ...
            const _ = v.isMobile(),
                ...
                V = {
                    ...
                    async getRecomendedWallets() {
                        ...
                        if (v.isArray(e)) {
                            ...
                            const {
                                chains: e,
                                isAuth: s
                            } = I.state, o = null === e || void 0 === e ? void 0 : e.join(","), n = v.isArray(t), a = {
                                page: 1,
                    ...
                    async getWallets(e) {
                        ...
                        n.length ? t.excludedIds = n.map((e => e.id)).join(",") : v.isArray(s) && (t.excludedIds = s.join(",")), v.isArray(o) && (t.excludedIds = [t.excludedIds, o].filter(Boolean).join(",")), I.state.isAuth && (t.sdks = "auth_v1");
                        const {
                            page: a,
                            search: r
                        } = e, {
                ...
                H = {
                    ...
                    open: async e => new Promise((t => {
                        ...
                        if (v.removeWalletConnectDeepLink(), I.setWalletConnectUri(null === e || void 0 === e ? void 0 : e.uri), I.setChains(null === e || void 0 === e ? void 0 : e.chains), m.reset("ConnectWallet"), s && o) B.open = !0, t();
                        else {
                            const e = setInterval((() => {
                                const s = I.state;
                                s.isUiLoaded && s.isDataLoaded && (clearInterval(e), B.open = !0, t())
                            }), 200)
                        }
                    })),
                    close() {
                ...
                Q = {
                    ...
                    setThemeConfig(e) {
                        ...
                        t && (G.themeMode = t), s && (G.themeVariables = ((e, t) => {
                            ...
                            if (z)
                                for (var s of z(t)) q.call(t, s) && F(e, s, t[s]);
                            return e
                        })({}, s))
                    }
                },
        ...
        774: (e, t, s) => {
            ...
            class n {
                ...
                async initUi() {
                    if (typeof window < "u") {
                        await Promise.all([s.e(741), s.e(3009)]).then(s.bind(s, 13009));
...
//# sourceMappingURL=774.e866d1bb.chunk.js.map